        ...
        {avatarSprings.map((springs, index) => (
          <AvatarIcon
            ...
            css={{
              ...
              backgroundImage: 'url(https://raw.githubusercontent.com/TeamZeroFlyer/ZeroFlyer_Front/main/public/icons/footerIcon/green'+ (footerList[status][index] === "" ? "home" : footerList[status][index]) +'.svg)',
